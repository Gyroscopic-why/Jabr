...
namespace JabrAPI
{
    ...
    { 
        ...
        {
            try { return UnsafeDecryptWithConsoleInfo(encrypted, reKey, displayInfo); }
            catch { return ""; }
        }
        static public string DecryptWithConsoleInfo(string encrypted, EncryptionKey reKey, out Exception? exception, bool displayInfo = true)
        {
            try
            {
                string result = UnsafeDecryptWithConsoleInfo(encrypted, reKey, displayInfo);
                exception = null;
        ...
        static private string UnsafeDecryptWithConsoleInfo(string encrypted, EncryptionKey reKey, bool displayInfo = true)
        {
            ...
            if (displayInfo) DecryptingInfo(buffer, exLength, maxEncodingLength, shifts.ToArray(), shCount, ids, decodedIds, encrypted, decrypted, realMessageLength);
            return decrypted;
        }
