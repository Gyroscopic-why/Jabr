...
namespace JabrAPI
{
    static public partial class RE5
    {
        ...
        {
            static public List<Byte> DecryptFastBytes(List<Byte> encrypted, BinaryKey reKey)
            {
            ...
            static public void DecryptFastBytesFile(string inputPath, string outputPath, BinaryKey reKey)
            {
