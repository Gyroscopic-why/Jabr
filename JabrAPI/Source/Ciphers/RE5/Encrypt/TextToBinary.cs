...
namespace JabrAPI.RE5
{
    ...
    {
        static public Byte[] TextToBinary_ASCII(string message, EncryptionKey reKey, bool throwExceptions = false)
            => ToBinary.ASCII(Text(message, reKey, throwExceptions));
        ...
        static public Byte[] TextToBinary_Utf8(string message, EncryptionKey reKey, bool throwExceptions = false)
            => ToBinary.Utf8(Text(message, reKey, throwExceptions));
        ...
        static public Byte[] TextToBinary_Utf16(string message, EncryptionKey reKey, bool throwExceptions = false)
            => ToBinary.Utf16(Text(message, reKey, throwExceptions));
        ...
        static public Byte[] TextToBinaryBE_Utf16(string message, EncryptionKey reKey, bool throwExceptions = false)
            => ToBinary.BigEndianUtf16(Text(message, reKey, throwExceptions));
        ...
        static public Byte[] TextToBinary_Utf32(string message, EncryptionKey reKey, bool throwExceptions = false)
            => ToBinary.Utf32(Text(message, reKey, throwExceptions));
