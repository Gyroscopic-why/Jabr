...
namespace Jabr
{
    internal class CustomFunctions
    {
        ...
        static public bool gAdvInfo = false, gClearUsed = true;
        ...
        static public void StdDeInfo() //Getting decoding info
        {
            string UserInput, AlphabetErrors = "☺", AlphabetDuplicates = "☺";
            bool SuccessfulParse = false, ConfirmMessage = false;

            //--------------------------------------------------------------------------------------//
            Write("\n\n\n\t\t\t--->  Дешифровка с помощью РЕ  <---\n\n");
